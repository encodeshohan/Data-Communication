...
analog_sig = a1*sin(2*pi*13*analog_t) + a2*cos(2*pi*15*analog_t) + a3*sin(2*pi*9*analog_t) + a4*sin (2*pi*10*analog_t);
figure
subplot(1,2,1)
...
samp_sig = a1*sin(2*pi*13*samp_t) + a2*cos(2*pi*15*samp_t) + a3*sin(2*pi*9*samp_t) + a4*sin (2*pi*10*samp_t);
subplot(1,2,2)
